...
{ writeShellApplication, runCommand, binutils-unwrapped,
  maxbin2, maxbin-rs, maxbin-rs-lto, rust, cargo-nextest,
...
in {
  ...
  bench-cpp-lto = writeShellApplication {
    name = "bench-cpp-lto";
    runtimeInputs = [ maxbin2 maxbin-rs maxbin-rs-lto ];
    text = ''
